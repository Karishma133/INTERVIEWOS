...
export default function Register() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] overflow-y-auto lg:overflow-hidden grid lg:grid-cols-2">
      {/* Left — brand panel (hidden on small screens) */}
      <div className="hidden lg:flex relative bg-navy-950 flex-col justify-between p-8 xl:p-12 overflow-hidden">
        ...
        <div className="relative">
          <h2 className="font-display text-2xl xl:text-3xl font-bold text-white leading-tight mb-5">
            Join the panel.
            <br />
      ...
      <div className="flex items-center justify-center px-4 py-5 sm:py-6">
        <div className="w-full max-w-sm">
          <h2 className="font-display text-xl sm:text-2xl font-bold text-navy-900 dark:text-gray-100 mb-1">Create your account</h2>
